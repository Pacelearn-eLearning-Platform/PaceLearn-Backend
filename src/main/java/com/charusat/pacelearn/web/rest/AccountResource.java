...
import com.charusat.pacelearn.service.dto.AdminUserDTO;
import com.charusat.pacelearn.service.dto.PasswordChangeDTO;
import com.charusat.pacelearn.web.rest.errors.*;
import com.charusat.pacelearn.web.rest.vm.KeyAndPasswordVM;
import com.charusat.pacelearn.web.rest.vm.ManagedUserVM;
import java.util.*;
...
public class AccountResource {
     ...
     * @throws InvalidEmailException {@code 400 (Bad Request)} if the login is already used.
     */
    ...
    public Map<String,AdminUserDTO> getCurrentAccount() {
        HashMap map = new HashMap();
        AdminUserDTO body = userService
                .getUserWithAuthorities()
                .map(AdminUserDTO::new)
                .orElseThrow(() -> new AccountResourceException("User could not be found"));
        map.put("user",body);
